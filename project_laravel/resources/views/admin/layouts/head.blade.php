...
<link rel="stylesheet" href="{{asset('admin_files/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')}}">
<!-- iCheck -->
<link rel="stylesheet" href="{{asset('admin_files/plugins/icheck-bootstrap/icheck-bootstrap.min.css')}}">
<!-- JQVMap -->
<link rel="stylesheet" href="{{asset('admin_files/plugins/jqvmap/jqvmap.min.css')}}">
<!-- Theme style -->
...
<!-- Daterange picker -->
<link rel="stylesheet" href="{{asset('admin_files/plugins/daterangepicker/daterangepicker.css')}}">
<!-- summernote -->
